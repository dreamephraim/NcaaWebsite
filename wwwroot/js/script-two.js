(function($) {
	...
	if($('.ft1-main-header .navigation li.dropdown').length){
		$('.ft1-main-header .navigation li.dropdown').append('<div class="dropdown-btn"><span class="bx bx-angle-down"></span></div>');
	...
	if ($('.single-item-carousel').length) {
		$('.single-item-carousel').owlCarousel({
			...
			smartSpeed: 500,
			autoplay: 6000,
			navText: [ '<span class="bx bx-angle-left"></span>', '<span class="bx bx-angle-right"></span>' ],
			responsive:{
				0:{
					items:1
				},
		...
		var $sync1 = $(".ft3-main-slider-two .image-carousel"),
			...
			$sync1
				.owlCarousel({
					...
					margin: 0,
					nav: true,
					navText: [ '<span class="icon bx bx-angle-left"></span>', '<span class="icon bx bx-angle-right"></span>' ],
					dots: false,
					autoplay: true,
